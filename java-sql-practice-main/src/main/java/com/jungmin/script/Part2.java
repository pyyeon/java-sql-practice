...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users (username, email, password) VALUES " +
          "('Bob', 'bob@naver.com', 'bobby12');";
  ...
  */
  public static final String PART2_9 = "UPDATE posts " +
  ...
  */
  public static final String PART2_12 = "SELECT title FROM Posts " +
          "WHERE user_id = 1; ";
  ...
  */
  public static final String PART2_16 = "SELECT u.username, COUNT(c.comment_id) AS CommentCount FROM Users AS u " +
  ...
  */
  public static final String PART2_18 = "SELECT b.name, AVG(sq.le) AS AvgLength " +
          "FROM (SELECT board_id, CHAR_LENGTH(content) AS le FROM Posts ) AS sq " +
          "RIGHT JOIN Boards AS b ON sq.board_id = b.board_id " +
          "GROUP BY b.name ;"  ;
  ...
  */
  public static final String PART2_19 = "SELECT b.name, AVG(sq.le) AS AvgLength " +
          "FROM (SELECT board_id, content, CHAR_LENGTH(content) AS le FROM Posts ) AS sq " +
          "RIGHT JOIN Boards AS b ON sq.board_id = b.board_id " +
          "GROUP BY b.name " +
          "Having sq.content is not null ;"  ;
