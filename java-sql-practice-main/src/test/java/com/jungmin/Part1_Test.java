...
public class Part1_Test {
  ...
  public void Query_Test_1_1() throws SQLException {
    ...
    assertThat(response.toString().toLowerCase().contains("users")).isTrue();
    assertThat(response.toString().toLowerCase().contains("tags")).isTrue();
    assertThat(response.toString().toLowerCase().contains("posts")).isTrue();
    assertThat(response.toString().toLowerCase().contains("post_tags")).isTrue();
    assertThat(response.toString().toLowerCase().contains("comments")).isTrue();
    assertThat(response.toString().toLowerCase().contains("boards")).isTrue();
